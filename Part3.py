...
class StockItem():
    ...
    def increaseStock(self,value):
        ...
        elif self.__quantity + value > 100:
...
def main():
    ...
    while runProgram: 
        ...
        while secondLoop:
            ...
            stockItemInput = int(input("Which stock item would you like to interact with? : "))
        ...
        while thirdLoop:
            ...
            # If user picks option 2, run function for setting price.
                ...
                newPrice = float(input("What would you like to set the new price as?: "))
